...
public class RevistaOnLineJuegos 
{
    ...
    public void add(Juego juego) 
    {
        ...
        {
            int insert = calcularPosicion(juego.getTitulo());
            
            System.arraycopy(juegos, insert, juegos, insert + 1, total - insert);
            juegos[insert] = juego;
    ...
    /**
     * Devuelve la posición en la que se inserta un titulo en el array juegos 
     */
    private int calcularPosicion(String titulo) 
    {
    ...
    {
        String[] retorno = new String[total];
        int pos = 0;
        ...
        for(int i = 0 ; i < total ; i++)
        {
            ...
            {
                retorno[pos] = juegos[i].getTitulo();
                pos++;
            }
        }
        
        return Arrays.copyOf(retorno, pos);
    }
    ...
    {
        System.arraycopy(juegos, pos + 1, juegos, pos, total - pos - 1);
        total--;
    }
